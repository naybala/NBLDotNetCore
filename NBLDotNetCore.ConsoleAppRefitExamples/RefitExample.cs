...
namespace NBLDotNetCore.ConsoleAppRefitExamples;

public class RefitExample
{
    private readonly IBlogApi _service = RestService.For<IBlogApi>("https://localhost:7105");
    ...
    public async Task RunAsync()
    {
        ...
        await EditAsync(1);
        await EditAsync(7);
        //await CreateAsync("title", "string 2", "string 3");
        //await UpdateAsync(7, "title 1", "string 2", "string 3");
        //await EditAsync(7);
        //await DeleteAsync(7);
    }
